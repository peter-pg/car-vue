import { c as createCommonjsModule } from './common/_commonjsHelpers-a9e5d039.js';
...
var _iterDefine = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      if (typeof IteratorPrototype[ITERATOR$5] != 'function') _hide(IteratorPrototype, ITERATOR$5, returnThis);
    }
  }
...
var DictIterator = function (iterated, kind) {
  this._t = _toIobject(iterated); // target
  this._a = _objectKeys(iterated);   // keys
  this._i = 0;                   // next index
  this._k = kind;                // kind
};
...
function set(object, key, value) {
  if (_descriptors && key in Object) _objectDp.f(object, key, _propertyDesc(0, value));
  else object[key] = value;
  return object;
}

function isDict(it) {
  return _isObject(it) && _objectGpo(it) === Dict.prototype;
}
...
var _objectDefine = function define(target, mixin) {
  ...
  var i = 0;
  var key;
  while (length > i) _objectDp.f(target, key = keys[i++], _objectGopd.f(mixin, key));
  return target;
};
...
_export(_export.S, 'RegExp', { escape: function escape(it) { return $re$2(it); } });
...
_export(_export.P + _export.F, 'String', { unescapeHTML: function unescapeHTML() { return $re(this); } });

var coreJs = _core;

export { coreJs as default };
